  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      <div className="bg-white text-gray-700 flex items-center">
        <div className="w-full max-w-md mx-auto px-6 py-12">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Not a member?{" "}
            <a href="/register" className="text-black hover:text-gray-700">
          ...
          <form className="mt-8 space-y-5">
            ...
            <div>
              ...
              <input
                ...
                value={form.password}
                onChange={handleChange}
                className="mt-2 w-full rounded-md bg-white border border-gray-300 focus:border-black focus:outline-none px-3 py-2 text-gray-900 placeholder-gray-400"
                placeholder="••••••••"
              />
            </div>
            ...
            <label className="flex items-center gap-2 text-sm text-gray-700">
              <input
                ...
                onChange={handleChange}
                className="rounded border-gray-300 bg-white text-black focus:ring-0"
              />
              Remember me
            </label>
      ...
      <div className="relative hidden lg:block">
        <img
          src="https://images.unsplash.com/photo-1484807352052-23338990c6c6?q=80&w=1600&auto=format&fit=crop"
          alt="Workspace"
